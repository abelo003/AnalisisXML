...
class JTableButtonModel extends AbstractTableModel {
    ...
    public JTableButtonModel() {
        JButton one = new JButton("my boton");
        one.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "jajjaa");
            }
        });
        __rows = new Object[][]{{"One", one}, {"Two", new JButton("Button Two")}, {"Three", new JButton("Button Three")}, {"Four", new JButton("Button Four")}};
    }
...
class JTableButtonMouseListener implements MouseListener {
    ...
    private void __forwardEventToButton(MouseEvent e) {
        ...
        button.dispatchEvent(buttonEvent); // This is necessary so that when a button is pressed and released // it gets rendered properly. Otherwise, the button may still appear // pressed down when it has been released. __
        __table.repaint();
    }
